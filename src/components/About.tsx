    ...
    <section id="about" className="py-20 relative">
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {skills.map((skill, index) => {
                  ...
                  return (
                    <div key={index} className={`group ${colorClasses.bg} backdrop-blur-sm rounded-xl p-6 border ${colorClasses.border} ${colorClasses.hover} transition-all duration-300 hover:scale-105`}>
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                <h3 className="text-xl font-bold text-white mb-6 text-center">SYSTEM METRICS</h3>
                  ...
                  {[
                    ...
                    return (
                      <div key={index} className={`text-center p-4 ${colorClasses.bg} backdrop-blur-sm rounded-xl border ${colorClasses.border} hover:scale-105 transition-all duration-300`}>
                        <div className={`text-3xl font-bold ${colorClasses.text} mb-1`}>{stat.value}</div>
          ...
          {/* Education */}
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/30">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-xl flex items-center justify-center">
                <span className="text-white font-bold text-xl">🎓</span>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white">EDUCATION MATRIX</h3>
                <p className="text-gray-400">Academic Timeline</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <span className="text-cyan-400 font-semibold">DEGREE</span>
                <h4 className="text-xl font-bold text-white">Bachelor of Computer Science</h4>
                <p className="text-purple-400">Major: CS | Minor: Software Engineering</p>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-green-400/10 border border-green-400/30 rounded-lg px-4 py-2 inline-block">
                  <span className="text-green-400 font-semibold">Expected Graduation: 2025</span>
                </div>
              </div>
            </div>
          </div>
